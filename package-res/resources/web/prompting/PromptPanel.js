 ...
 */
define(['amd!cdf/lib/underscore', 'cdf/lib/Base', 'cdf/Logger', 'dojo/number', 'dojo/i18n', 'common-ui/util/GUIDHelper', './WidgetBuilder', 'cdf/Dashboard.Clean', './components/PostInitComponent', './parameters/ParameterDefinitionDiffer'],
    function (_, Base, Logger, DojoNumber, i18n, GUIDHelper, WidgetBuilder, Dashboard, PostInitComponent, ParamDiff) {
